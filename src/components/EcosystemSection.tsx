import { Store, PartyPopper, Pill, CreditCard, ArrowRight } from "lucide-react";
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-muted-foreground text-lg max-w-2xl mx-auto">
            O saldo que o cliente usa na festa é o mesmo que ele usa na adega parceira.
            Criamos um loop de consumo dentro da cidade.
          </p>
        </div>
          ...
          <div className="glass-card rounded-2xl p-8 md:p-12">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {sectors.map((s, i) => (
                <div key={i} className="text-center group">
                  ...
                  <h4 className="font-heading font-semibold text-sm">{s.label}</h4>
            ...
            <div className="mt-8 text-center">
              <p className="text-muted-foreground text-sm leading-relaxed max-w-lg mx-auto">
                Uma única conta, uma única experiência. O consumidor transita entre todos os 
                setores parceiros com o mesmo saldo e a mesma identidade. Mais conveniência, 
                mais fidelização, mais receita recorrente.
              </p>
            </div>
          </div>
        </div>
